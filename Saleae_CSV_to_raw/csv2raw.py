...
if not options.infile or not options.outfile:
    print("\t This script converts the CSV file exported from Saleae Logic 1.2.18 into the raw bytes \n \t You must specify -i infile and -o outfile (outfile will be overwritten)")
    exit(-1)
